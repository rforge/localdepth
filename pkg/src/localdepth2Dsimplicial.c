...
/* per il diametro */
void ld2Ddiamsimp(double *x1, double *x2, double *y1, double *y2, double *tau, int *nx, int *ny, double *depth, double *ldepth) {
...
void ld2Dareasimp(double *x1, double *x2, double *y1, double *y2, double *tau, int *nx, int *ny, double *depth, double *ldepth) {
